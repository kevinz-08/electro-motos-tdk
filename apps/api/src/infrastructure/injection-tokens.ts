...
export const KIT_REPOSITORY                  = Symbol('IKitRepository')
// Fase 5: revisores tecnicos y guias de mantenimiento (docs/seo/)
export const TECHNICAL_REVIEWER_REPOSITORY   = Symbol('ITechnicalReviewerRepository')
export const MAINTENANCE_GUIDE_REPOSITORY    = Symbol('IMaintenanceGuideRepository')
